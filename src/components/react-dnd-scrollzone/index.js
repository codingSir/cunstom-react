...
import { noop, intBetween, getCoords, getDisplayName } from "./util";
...
export default function createScrollingComponent(WrappedComponent) {
    class ScrollingComponent extends Component {
        ...
        componentDidMount() {
            ...
            this.props.getContainer.document.body.addEventListener(
                "touchmove",
                this.handleEvent
            );
        ...
        componentWillUnmount() {
            ...
            this.props.getContainer.document.body.removeEventListener(
                "touchmove",
                this.handleEvent
            );
        ...
        handleMonitorChange() {
            const isDragging = this.props.dragDropManager
                .getMonitor()
                .isDragging();
